                    ...
                    <div key={p.id} className="js-card overflow-hidden" data-testid={`fav-product-${p.id}`}>
                      ...
                      <div className="p-3">
                        ...
                        <div className="flex gap-2 mt-3">
                          <button
                            onClick={() => { const ok = addItem({ item_type: "product", item_id: p.id, name: p.name, price_usd: p.price_usd, image_url: p.image_url, exchange_rate_ssp: p.exchange_rate_ssp, quantity: 1 }); if (ok) toast.success("Added"); }}
